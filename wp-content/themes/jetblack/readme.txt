...
JetBlack includes support for Infinite Scroll in Jetpack, Breadcrunb NXT for advanced breadcrumb solution.

== Changelog ==

= 1.1.4 - 8 Feb, 2021 =
* Fix: Escaping issues in custom control
* Fix: Top bar accessibility issue

= 1.1.3 - 6 Feb, 2021 =
* Fix: WWD section acccidental files removal

= 1.1.2 - 3 Feb, 2021 =
* Update: Support for JetBlack Pulse child theme

= 1.1.1 - 17 December, 2020 =
* Update: FontAwesome to 5.15.1
* Update: CSS updates

= 1.1.0 - 26 November 2020 =
* Add: Support for Top bar in Jetblack Education child theme of Jetblack

= 1.0.9 - 24 November 2020 =
* Add: Accessibility CSS update

= 1.0.8 - 14 November 2020 =
* Add: Missing edit shortcuts in customizer
* Fix: CSS glow removed
* Update: Slider auto-height

= 1.0.7 - 9 October 2020 =
* Remove: Unnecessary codes

= 1.0.6 - 8 September 2020 =
* Fix: Breadcrumb issue

= 1.0.5 - 7 September 2020 =
* Fix: Keyboard navigation issues

= 1.0.4 - 5 September 2020 =
* Fix: Breadcrumb issue

= 1.0.3 - 3 September 2020 =
* Update: Minor CSS updates

= 1.0.2 - 1 September 2020 =
* Remove: Flashy CSS

= 1.0.1 - 24 August 2020 =
* Add: Post formats support
* Update: Theme Description and links
...
Images
	All images are licensed under [CC0] (https://creativecommons.org/publicdomain/zero/1.0/)
		* Screenshot and header image: https://stocksnap.io/photo/business-man-FCUDWWBKFV
