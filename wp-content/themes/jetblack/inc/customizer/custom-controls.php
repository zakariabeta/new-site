<?php
/**
 * JetBlack Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	 class JetBlack_Image_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_image_checkbox';
	 ...
	 */
	 class JetBlack_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_text_radio_button';
	 ...
	 */
	class JetBlack_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_image_radio_button';
	 ...
	 */
	class JetBlack_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_simple_notice';
	 ...
	 */
	class JetBlack_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_slider_control';
	 ...
	 */
	class JetBlack_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_toggle_switch';
	 ...
	 */
	class JetBlack_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_sortable_repeater';
	 ...
	 */
	class JetBlack_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_dropdown_select2';
	 ...
	 */
	class JetBlack_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_dropdown_posts';
					...
					<?php
						if( !empty( $this->posts ) ) {
							foreach ( $this->posts as $post ) {
								...
								if ( empty( $title ) ) {
									$title = sprintf( esc_html__( 'ID: %s No Title', 'jetblack' ), $post->ID );
								}
	 ...
	 */
	class JetBlack_TinyMCE_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_tinymce_editor';
		...
		public function to_json() {
			parent::to_json();
			$this->json['jetblacktinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['jetblacktinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['jetblackmediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
	 ...
	 */
	class JetBlack_Note_Control extends WP_Customize_Control {
		public $type = 'jetblack_description';

		public function render_content() {
			echo '<hr><h2 class="description">' . $this->label . '</h2>';
		}
	}
	 ...
	 *
	 */
	class JetBlack_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'jetblack_jetblack-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="jetblack_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'jetblack_url_sanitization' ) ) {
		function jetblack_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'jetblack_switch_sanitization' ) ) {
		function jetblack_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'jetblack_radio_sanitization' ) ) {
		function jetblack_radio_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'jetblack_text_sanitization' ) ) {
		function jetblack_text_sanitization( $input ) {
	 ...
	 */
	function jetblack_sanitize_select( $input, $setting ) {
